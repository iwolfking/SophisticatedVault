...
public abstract class MixinWoodenStorageBlockBase extends StorageBlockBase implements IAdditionalDropDataBlock {
    ...
    static {
        ...
        VAULT_WOOD_TYPES = Map.of(VaultWoodTypes.DRIFTWOOD, VaultBlockFamilies.DRIFTWOOD, VaultWoodTypes.CHROMATIC, VaultBlockFamilies.CHROMATIC, VaultWoodTypes.OVERGROWN, VaultBlockFamilies.OVERGROWN, VaultWoodTypes.VAULT_PLANKS, VaultBlockFamilies.VAULT_PLANKS, VaultWoodTypes.TENOS, VaultBlockFamilies.TENOS, VaultWoodTypes.VELARA, VaultBlockFamilies.VELARA);
